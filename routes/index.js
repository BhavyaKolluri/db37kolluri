...
router.get('/', function (req, res) {
 res.render('index', { title: 'Fairydoll App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'Fairydoll App Registration'});
});
...
router.get('/login', function(req, res) {
 res.render('login', { title: 'Fairydoll App Login', user : req.user });
});
